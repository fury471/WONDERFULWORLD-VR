...
- Move or rename assets only in Unity so `.meta` GUID references remain valid.

## Current World Workflow

- The team is building one master playable park scene, not separate playable region scenes.
